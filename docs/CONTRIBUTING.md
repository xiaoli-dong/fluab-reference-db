...
# `provlab-bioinfo/fluab_reference_db`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving provlab-bioinfo/fluab_reference_db.

This page describes the recommended nf-core way to contribute to both provlab-bioinfo/fluab_reference_db and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of provlab-bioinfo/fluab_reference_db.
...
- [ ] Check whether a GitHub [issue](https://github.com/provlab-bioinfo/fluab_reference_db/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [provlab-bioinfo/fluab_reference_db repository](https://github.com/provlab-bioinfo/fluab_reference_db) to your GitHub account.
...
nf-core semi-standardises how you write code and other contributions to make the provlab-bioinfo/fluab_reference_db code and processing logic more understandable for new contributors and to ensure quality.
